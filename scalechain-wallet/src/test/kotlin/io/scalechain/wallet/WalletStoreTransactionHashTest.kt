...
/**
  ...
  */
interface WalletStoreTransactionHashTest : ShouldSpec, WalletStoreTestInterface {
  ...
  fun addTests() {
    ...
    "getTransactionHashes" should "get all transaction hashes for an output ownership." {
