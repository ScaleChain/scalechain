...
class WalletStore {
  ...
  companion object {
    ...
    const val OWNERSHIPS = 'O'.code.toByte()

    // B. (OutputOwnership, OwnershipDescriptor)
    const val OWNERSHIP_DESC = 'D'.code.toByte()

    // C. (Account, OutputOwnership)
    const val RECEIVING = 'R'.code.toByte()

    /////////////////////////////////////////////////////////////////////////////////////////////////
    // Output Ownership -> Transactions
    /////////////////////////////////////////////////////////////////////////////////////////////////
    // A. ( OutputOwnership + '\0' + (transaction)Hash )
    const val TXHASHES = 'H'.code.toByte()

    /////////////////////////////////////////////////////////////////////////////////////////////////
    // Output Ownership -> UTXOs
    /////////////////////////////////////////////////////////////////////////////////////////////////
    // A. ( OutputOwnership + '\0' + OutPoint, None )
    const val OUTPOINTS = 'P'.code.toByte()
    ...
    // Keys and Values (K, V) :
    // A. ((transaction)Hash, WalletTransaction)
    const val WALLETTX = 'T'.code.toByte()
    ...
    // Keys and Values (K, V) :
    // A. (OutPoint, WalletOutput)
    const val WALLETOUTPUT = 'U'.code.toByte()
  }
