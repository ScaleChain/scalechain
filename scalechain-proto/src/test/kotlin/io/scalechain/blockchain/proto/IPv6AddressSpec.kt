...
class IPv6AddressSpec : FlatSpec(), Matchers {
    init {
        "inetAddress" should "return InetAddress by reading big endian encoding of the adress in the address property." {
            ...
            IPv6Address( Bytes.from( "7f 00 00 01") ).inetAddress().toString() shouldBe "/127.0.0.1"
            ...
            IPv6Address( Bytes.from( "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01") ).inetAddress().toString() shouldBe "/0:0:0:0:0:0:0:1"
            ...
            IPv6Address( Bytes.from( "20 01 0d b8 00 00 00 00 00 00 00 00 00 00 00 01") ).inetAddress().toString() shouldBe "/2001:db8:0:0:0:0:0:1"
            ...
            IPv6Address( Bytes.from( "00 00 00 00 00 00 00 00 00 00 00 00 c0 a8 00 01") ).inetAddress().toString() shouldBe "/0:0:0:0:0:0:c0a8:1"
            ...
            IPv6Address( Bytes.from( "00 00 00 00 00 00 00 00 00 00 ff ff c0 a8 00 01") ).inetAddress().toString() shouldBe "/192.168.0.1"
