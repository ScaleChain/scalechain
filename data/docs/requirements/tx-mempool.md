# Introduction
We need to implement the transaction mempool, where transactions are kept before it is put onto a block.
In this document, we will analyze each of functions and see when these functions are called to better understand mempool operations.

## (P1) Need to implement mempool
