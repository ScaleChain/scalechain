## CA
ocb-ca/server.go seems to be for running a server for CA.
...
## API
### openchain : protos/api.proto

Get block by number, and get the total block count.
...
### major protocols ; protos/openchain.proto
