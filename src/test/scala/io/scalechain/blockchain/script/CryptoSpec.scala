...
class CryptoSpec extends FlatSpec with BeforeAndAfterEach with OperationTestTrait {
  ...
  val operations =
    Table(
      ...
      // Before : in
      // After  : hash
      ( stack("Hello World!"), OpRIPEMD160(), stack(HexUtil.hex2bytes("8476ee4631b9b30ac2754b0ee0c47e161d3f724c"))),
      ( stack(),               OpRIPEMD160(), ErrorCode.NotEnoughInput),

      // OP_SHA1(0xa7) : Return SHA1 hash of top item
      // Before : in
      // After  : hash
      ( stack("Hello World!"), OpSHA1(), stack(HexUtil.hex2bytes("2ef7bde608ce5404e97d5f042f95f89f1c232871"))),
      ( stack(),               OpSHA1(), ErrorCode.NotEnoughInput),

      // OP_SHA256(0xa8) : Return SHA256 hash of top item
      // Before : in
      // After  : hash
      ( stack("Hello World!"), OpSHA256(), stack(HexUtil.hex2bytes("7f83b1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9069"))),
      ...
      ( stack("Hello World!"), OpHash160(), stack(HexUtil.hex2bytes("85b0c1edc20ec4437ab5f936a7e1691498dd0a73"))),
      ...
      // After  : hash
      // BUGBUG : The expected value was copied from the actual output. Make sure it is correct.
      ( stack("Hello World!"), OpHash256(), stack(HexUtil.hex2bytes("61f417374f4400b47dcae1a8f402d4f4dacf455a0442a06aa455a447b0d4e170"))),
