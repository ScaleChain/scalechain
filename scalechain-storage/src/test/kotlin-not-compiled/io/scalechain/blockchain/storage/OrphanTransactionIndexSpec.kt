...
/**
  ...
  */
class OrphanTransactionIndexSpec  : FlatSpec with Matchers with BeforeAndAfterEach {
  this: Suite =>
  ...
  /** Create a dummy orphan block.
    ...
    */
  fun orphanTransaction(num : Int) = OrphanTransactionDescriptor(
