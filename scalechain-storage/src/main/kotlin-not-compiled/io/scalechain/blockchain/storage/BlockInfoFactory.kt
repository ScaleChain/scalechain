...
protected<storage> object BlockInfoFactory {
  /** Create a block information.
    ...
    */
  fun create(prevBlockInfoOption : Option<BlockInfo>, blockHeader : BlockHeader, blockHash : Hash, transactionCount : Int, blockLocatorOption : Option<FileRecordLocator>) : BlockInfo {
