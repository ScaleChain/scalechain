...
interface TransactionTestInterface : ChainTestTrait, ProtoTestData {
...
object TransactionTestData {
  private val txTestData = object : TransactionTestInterface {}
  private val __env = txTestData.env() // create environment for coin address generation
  val TXHASH1 = txTestData.transaction1().hash()
  val TXHASH2 = txTestData.transaction2().hash()
  val TXHASH3 = txTestData.transaction3().hash()
  /*
