...
class OddTransactionVerificationSpec extends FlatSpec with BeforeAndAfterEach with SignatureTestTrait {
  ...
  val transactionInputs =
    ...
    /*
      (
        "[[ErrorCode(invalid_signature_format)]message=ScriptOp:CheckSig]-2",
      ...
      (
        ...
        MergedScript(transaction=Transaction(version=1, inputs=List(NormalTransactionInput(outputTransactionHash=TransactionHash(bytes("9c08a4d78931342b37fd5f72900fb9983087e6f46c4a097d8a1f52c74e28eaf6")), outputIndex=1L, unlockingScript=UnlockingScript(bytes("255121029b6d2c97b8b7c718c325d7be3ac30f7c9d67651bce0c929f55ee77ce58efcf8451ae")) /* ops:ScriptOpList(operations=Array(OpPush(37,ScriptBytes(bytes("5121029b6d2c97b8b7c718c325d7be3ac30f7c9d67651bce0c929f55ee77ce58efcf8451ae"))))), hashType:Some(-82) */, sequenceNumber=4294967295L)), outputs=List(TransactionOutput(value=350000L, lockingScript=LockingScript(bytes("76a9145a3acbc7bbcc97c5ff16f5909c9d7d3fadb293a888ac")) /* ops:ScriptOpList(operations=Array(OpDup(),OpHash160(),OpPush(20,ScriptBytes(bytes("5a3acbc7bbcc97c5ff16f5909c9d7d3fadb293a8"))),OpEqualVerify(),OpCheckSig(Script(bytes("76a9145a3acbc7bbcc97c5ff16f5909c9d7d3fadb293a888ac"))))) */ )), lockTime=0L /* hash:bytes("6a26d2ecb67f27d1fa5524763b49029d7106e91e3cc05743073461a719776192") */), inputIndex=0, unlockingScript=UnlockingScript(bytes("255121029b6d2c97b8b7c718c325d7be3ac30f7c9d67651bce0c929f55ee77ce58efcf8451ae")) /* ops:ScriptOpList(operations=Array(OpPush(37,ScriptBytes(bytes("5121029b6d2c97b8b7c718c325d7be3ac30f7c9d67651bce0c929f55ee77ce58efcf8451ae"))))), hashType:Some(-82) */, lockingScript=LockingScript(bytes("a91419a7d869032368fd1f1e26e5e73a4ad0e474960e87")) /* ops:ScriptOpList(operations=Array(OpHash160(),OpPush(20,ScriptBytes(bytes("19a7d869032368fd1f1e26e5e73a4ad0e474960e"))),OpEqual())) */ )
      ),
      */
      (
        "[[ErrorCode(invalid_signature_format)]message=ScriptOp:CheckMultiSig, invalid raw signature format.]",
